...
(function (window, document, $) {
    ...
    window.GNB_STYLES = {
        general: 'http://static.joins.com/joongang_15re/styles/pc/gnb.css',
        gray: 'http://static.joins.com/joongang_15re/styles/pc/gnb_gray.css',
        black: 'http://static.joins.com/joongang_15re/styles/pc/gnb_black.css',
        rio2016: 'http://local.static.joins.com/joongang_15re/styles/pc/gnb_rio2016.css'
    };
    ...
    */
    var
        defaults = {
            ...
            'homePath': { 'editable': true, 'value': 'http://joongang.joins.com' },
            'staticPath': { 'editable': true, 'value': 'http://static.joins.com/joongang_15re' },
            'imagePath': { 'editable': true, 'value': 'http://images.joins.com/ui_joongang/news' },
            'searchWebPath': { 'editable': true, 'value': 'http://search.joins.com' },
            'searchEnginePath': { 'editable': true, 'value': 'http://searchapi.joins.com' },
            'apiPath': { 'editable': true, 'value': 'http://apis.joins.com' },
            'cruzPath': { 'editable': true, 'value': 'http://cruz.joins.com' },
            'pdsPath': { 'editable': true, 'value': 'http://pds.joins.com' },
            'irPath': { 'editable': true, 'value': 'http://ir.joins.com' },
            'JtbcImagePath': { 'editable': true, 'value': 'http://photo.jtbc.joins.com' },
            'webPcPath': { 'editable': true, 'value': 'http://news.joins.com' },
            'webMobilePath': { 'editable': true, 'value': 'http://mnews.joins.com' },
            'jplusPath': { 'editable': true, 'value': 'http://jplus.joins.com' },
	    ...
	    */
        ...
        this.setStartPage = function () {
            ...
            if (document.all) {
                ...
                document.body.setHomePage('http://joongang.joins.com');
        ...
        this.newsRoom = new function () {
            ...
            return {
                ...
                init: function () {
                    ...
                    var jtbcScheduleFile = 'http://fs.jtbc.joins.com/common/data/schedule/schedule_day3.js';
        ...
        this.opinionCast = new function () {
            ...
            return {
                ...
                init: function () {
                    ...
                    var opinionCastSchedule = 'http://static.joins.com/joongang_15re/scripts/data/opinioncast/js/index_onair_schedule.js',
                        opinionCastScheduleTemp = 'http://local.static.joins.com/scripts/data/opinioncast/js/index_onair_schedule.js';
        ...
        this.setTrackingLog = function (options) {
            ...
            var logMaps = {
                'photo': { url: 'http://log.news.joins.com/PhotoGalleryLogCollector.html?div=' },
                'image': { url: 'http://log.news.joins.com/BundlePhotoLogCollector.html?div=' },
                'article': { url: 'http://log.news.joins.com/NewsArticleLogCollector.html?div=' }
            };
        ...
        this.redirectUrl = function () {
            ...
            function getSearchRedirectObject() {
                var mapper = {
                    ...
                    pc: 'http://search.joins.com' + search
                }
