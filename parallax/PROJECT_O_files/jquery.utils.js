	...
	*/
	...
	$.fn.loadAd = function (options) {
		...
		AD_INFO = {
			...
			'da_250_570': { width: '250', height: '250', src: 'http://dgate.joins.com/hc.aspx?ssn=570&b=joins.com', id: 'DASlot570', name: 'DASlot570' },   //디스플레이_250x250(메인2)
			...
			'da_250_politics': { width: '250', height: '250', src: 'http://dgate.opap.co.kr/hc.aspx?ssn=1057&b=opap.co.kr', id: 'DASlot1057', name: 'DASlot1057' },
			...
			'display_799': { width: '300', height: '250', src: 'http://dgate.joins.com/hc.aspx?ssn=799&b=joins.com', id: 'DASlot799', name: 'DASlot799' }, //디스플레이_300x250(선데이홈)
			...
			//'ab_adtxt_lt_1': { width: '300', height: '57', src: 'http://adv.mediaharbor.co.kr/nad/media/02VA1RdVsM/uWkr8Df3on_in.html', title: '아티클 바이라인 하단 광고1', id: 'ab_adtxt_lt_1', name: 'ab_adtxt_lt_1' },
			//'ab_adtxt_lt_3': { width: '300', height: '28', src: 'http://adv.mediaharbor.co.kr/nad/media/02VA1RdVsM/CU3QPq9gSX_in.html', title: '아티클 바이라인 하단 광고3', id: 'ab_adtxt_lt_3', name: 'ab_adtxt_lt_3' },
			'ab_adtxt_lt_1': { width: '300', height: '84', src: 'http://adgrp1.ad4989.co.kr/cgi-bin/PelicanC.dll?impr?pageid=00Yj&out=iframe', title: '아티클 바이라인 하단 광고1,3', id: 'ab_adtxt_lt_1', name: 'ab_adtxt_lt_1' },
			...
			'ab_adtxt_lt_4': { width: '300', height: '28', src: 'http://adv.imadrep.co.kr/1754_01.html', title: '아티클 바이라인 하단 광고4', id: 'ab_adtxt_lt_4', name: 'ab_adtxt_lt_4' },
			...
			'ad_text_recommanded': { width: '260', height: '42', src: 'http://adgrp1.ad4989.co.kr/cgi-bin/PelicanC.dll?impr?pageid=00Nc&out=iframe', title: '아티클 우측 추천기사 텍스트', id: 'ad_text_recommanded', name: 'ad_text_recommanded' },
			...
			'display_1035': { width: '300', height: '250', src: 'http://dgate.joins.com/hc.aspx?ssn=1035&b=joins.com', id: 'DASlot1035', name: 'DASlot1035' } //디스플레이_300x250(반퇴시대)
		};
		//return false;
		var $p = this,
	...
	$.fn.setPagingDate = function () {
		...
		$datepicker.datepicker({
			...
			beforeShowDay: function (date) {
				if (window.location.pathname.toLowerCase().indexOf('/sunday/') > -1) {
					var day = date.getDay();
					return [(true, day == 0)];
				} else {
					var result = [true, ""];
